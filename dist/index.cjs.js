...
var Icon$4 = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 14 14" }, props),
        React__default['default'].createElement("path", { d: "M13 8L8 8V13C8 13.55 7.55 14 7 14C6.45 14 6 13.55 6 13V8L1 8C0.45 8 0 7.55 0 7C0 6.45 0.45 6 1 6L6 6V1C6 0.45 6.45 0 7 0C7.55 0 8 0.45 8 1V6L13 6C13.55 6 14 6.45 14 7C14 7.55 13.55 8 13 8Z", fill: props.color })));
};
...
var ButtonMenu = function (_a) {
    ...
    return (React__default['default'].createElement(StyledButtonMenu, { variant: invariant, style: {
...
var RotatingPancakeIcon = styled__default['default'](Icon$M)(templateObject_4$1 || (templateObject_4$1 = __makeTemplateObject(["\n  position: absolute;\n  top: 0;\n  left: 0;\n  animation: ", " 2s linear infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  position: absolute;\n  top: 0;\n  left: 0;\n  animation: ", " 2s linear infinite;\n  transform: translate3d(0, 0, 0);\n"])), rotate$1);
var FloatingPanIcon = styled__default['default'](Icon$L)(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n  animation: ", " 6s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  animation: ", " 6s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"])), float);
...
var Logo$1 = function (_a) {
    ...
    return (React__default['default'].createElement(Flex, null, isAbsoluteUrl ? (React__default['default'].createElement(StyledLink$1, { as: "a", href: href, "aria-label": "Fastswap home page" }, innerLogo)) : (React__default['default'].createElement(StyledLink$1, { to: href, "aria-label": "Fastswap home page" }, innerLogo))));
};
...
var templateObject_1$A, templateObject_2$b, templateObject_3$6;
...
var Accordion = function (_a) {
    ...
    return (React__default['default'].createElement(Container$2, null,
        React__default['default'].createElement(MenuEntry, { onClick: handleClick, className: className, isActive: isActive },
            icon,
            React__default['default'].createElement(LinkLabelMemo, { isPushed: isPushed, style: { fontFamily: 'CircularStd' } }, label),
        ...
        if (entry.items) {
            ...
            return (React__default['default'].createElement(Accordion$1, { key: entry.label, isPushed: isPushed, pushNav: pushNav, icon: iconElement, label: entry.label, initialOpenState: initialOpenState, className: calloutClass, isActive: entry.items.some(function (item) { return item.href === location.pathname; }) }, isPushed &&
                entry.items.map(function (item) { return (React__default['default'].createElement(MenuEntry, { key: item.href, secondary: true, isActive: item.href === location.pathname, onClick: handleClick },
                    React__default['default'].createElement(MenuLink, { href: item.href, style: { fontFamily: 'CircularStd' } }, item.label))); })));
        }
        return (React__default['default'].createElement(MenuEntry, { key: entry.label, isActive: entry.href === location.pathname, className: calloutClass },
            React__default['default'].createElement(MenuLink, { href: entry.href, onClick: handleClick },
                iconElement,
                React__default['default'].createElement(LinkLabelMemo, { isPushed: isPushed, style: { fontFamily: 'CircularStd' } }, entry.label))));
    })));
};
var templateObject_1$C;
...
var CakePrice = function (_a) {
    ...
    return cakePriceUsd ? (React__default['default'].createElement(PriceLink, { href: "http://info.fastswap.finance/token/0xfea6218871b7851748881a4af6bca63af1b769a8", target: "_blank" },
...
var UserBlock = function (_a) {
    ...
    return (React__default['default'].createElement("div", null, account ? (React__default['default'].createElement(Button, { scale: "sm", variant: "primary", onClick: function () {
            onPresentAccountModal();
        }, height: "37px", style: { borderRadius: '45px', fontWeight: 450, fontFamily: 'CircularStd' } }, accountEllipsis)) : (React__default['default'].createElement(Button, { scale: "sm", variant: "special", onClick: function () {
            onPresentConnectModal();
        }, height: "37px", startIcon: React__default['default'].createElement(Icon$E, null), style: { borderRadius: '45px', fontWeight: 450, fontFamily: 'CircularStd' } }, "Connect wallet"))));
};
...
var LangSelector = function (_a) {
    ...
    return (React__default['default'].createElement(Dropdown, { position: "bottom", target: React__default['default'].createElement(Button, { variant: "text", padding: "0px 8px", startIcon: React__default['default'].createElement(LanguageIcon, { color: "#36465E" }) },
            React__default['default'].createElement(Text, { color: "#36465E", style: { fontSize: 12, margin: '0px 0px 32px -12px' } }, currentLang === null || currentLang === void 0 ? void 0 : currentLang.toUpperCase())) }, langs.map(function (lang) { return (React__default['default'].createElement(MenuButton, { key: lang.code, fullWidth: true, onClick: function () {
...
var ThemeSwitcher = function (_a) {
    ...
    return (React__default['default'].createElement(Button, { variant: "text", onClick: function () { return toggleTheme(!isDark); }, padding: "0px 8px" },
        React__default['default'].createElement(Flex, { alignItems: "center" },
            React__default['default'].createElement(SunIcon, { fill: isDark ? "white" : "#183B56" }),
            React__default['default'].createElement(Text, { color: isDark ? "white" : "#183B56", mx: "4px" }, "/"),
            React__default['default'].createElement(MoonIcon, { fill: isDark ? "white" : "#183B56" }))));
};
...
var DropdownContent$1 = styled__default['default'].div(templateObject_1$K || (templateObject_1$K = __makeTemplateObject(["\n  width: max-content;\n  display: none;\n  flex-direction: column;\n  position: absolute;\n  transform: translate(-50%, 0);\n  left: ", ";\n  bottom: ", ";\n  padding: 16px;\n  max-height: 500px;\n  overflow-y: auto;\n  z-index: 10;\n  border-radius: 20;\n"], ["\n  width: max-content;\n  display: none;\n  flex-direction: column;\n  position: absolute;\n  transform: translate(-50%, 0);\n  left: ", ";\n  bottom: ", ";\n  padding: 16px;\n  max-height: 500px;\n  overflow-y: auto;\n  z-index: 10;\n  border-radius: 20;\n"])), getLeft$1, getBottom$1);
var Container$5 = styled__default['default'].div(templateObject_2$g || (templateObject_2$g = __makeTemplateObject(["\n  position: relative;\n  &:hover ", ", &:focus-within ", " {\n    display: flex;\n  }\n"], ["\n  position: relative;\n  &:hover ", ", &:focus-within ", " {\n    display: flex;\n  }\n"])), DropdownContent$1, DropdownContent$1);
...
var NavMenu = styled__default['default'].div(templateObject_6 || (templateObject_6 = __makeTemplateObject(["\n  display: flex;\n  justify-content: space-between;\n  width: 300px;\n  margin-left: 128px;\n\n  @media (max-width: 967px) {\n    margin-left: 20px;\n  }\n\n  @media (max-width: 670px) {\n    display: none;\n  }\n"], ["\n  display: flex;\n  justify-content: space-between;\n  width: 300px;\n  margin-left: 128px;\n\n  @media (max-width: 967px) {\n    margin-left: 20px;\n  }\n\n  @media (max-width: 670px) {\n    display: none;\n  }\n"])));
var Navigate = styled__default['default'](reactRouterDom.Link)(templateObject_7 || (templateObject_7 = __makeTemplateObject(["\n  font-family: CircularStd;\n  font-size: 18px;\n  font-weight: 450;\n  color: ", ";\n"], ["\n  font-family: CircularStd;\n  font-size: 18px;\n  font-weight: 450;\n  color: ", ";\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.text;
});
var StyledA = styled__default['default'].a(templateObject_8 || (templateObject_8 = __makeTemplateObject(["\n  font-family: CircularStd;\n  font-size: 18px;\n  font-weight: 450;\n  color: ", ";\n"], ["\n  font-family: CircularStd;\n  font-size: 18px;\n  font-weight: 450;\n  color: ", ";\n"
    // const btnStyle = {
    //   marginRight: 8,
    //   height: 40,
    //   width: 65,
...
//   borderRadius: '40px'
// }
var MyButton = styled__default['default'].div(templateObject_9 || (templateObject_9 = __makeTemplateObject(["\n  background-color:", "\n"], ["\n  background-color:", "\n"])), function (_a) {
    var theme = _a.theme;
    return theme.nav.background;
});
var MyDropdown = styled__default['default'].div(templateObject_10 || (templateObject_10 = __makeTemplateObject(["\n  background-color:", "\n"], ["\n  background-color:", "\n"])), function (_a) {
    var theme = _a.theme;
    return theme.nav.background;
});
var ChainName = styled__default['default'].span(templateObject_11 || (templateObject_11 = __makeTemplateObject(["\n  color:", "\n"], ["\n  color:", "\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.text;
});
var listStyle = {
...
var MarketPanel = styled__default['default'].div(templateObject_12 || (templateObject_12 = __makeTemplateObject(["\n  padding-top: ", ";\n"], ["\n  padding-top: ", ";\n"])), function (_a) {
    var showMenu = _a.showMenu;
    return (showMenu ? "66px" : 0);
});
...
var EthereumIcon = function (props) {
    return (React__default['default'].createElement("svg", __assign({ width: "25", height: "25", viewBox: "0 0 32 32" }, props),
...
var Menu = function (_a) {
    ...
    return (React__default['default'].createElement(Wrapper$1, null,
        React__default['default'].createElement(StyledNav, { showMenu: showMenu, isMarket: isMarket },
            React__default['default'].createElement(Flex, { alignItems: "center" },
                ...
                React__default['default'].createElement(NavMenu, null,
                    React__default['default'].createElement(StyledA, { href: "https://fastswap.finance", target: "_blank" }, "Trade"),
                    React__default['default'].createElement(Navigate, { to: "#" }, "Earn"),
                    React__default['default'].createElement(Navigate, { to: "#" }, "Win"),
                    React__default['default'].createElement(StyledA, { href: "https://nft.fastswap.finance", target: "_blank" }, "NFT"))),
            React__default['default'].createElement(Flex, { alignItems: "center" },
                ...
                React__default['default'].createElement(Dropdown$1, { position: "bottom", target: React__default['default'].createElement(MyButton, { style: {
                            marginRight: '8px',
                            padding: '7px 10px',
                            borderRadius: '40px',
                            alignItems: 'center'
                    ...
                    React__default['default'].createElement(MyDropdown, { style: {
                        ...
                        React__default['default'].createElement("a", { href: "https://fastswap.finance/#/swap", style: listStyle },
                            React__default['default'].createElement(BinanceIcon, { style: { width: 20, height: 20 } }),
                            React__default['default'].createElement(ChainName, { style: { fontFamily: 'CircularStd' } }, "Binance")),
                        React__default['default'].createElement("a", { href: "https://fastswap.exchange/", style: listStyle },
                            React__default['default'].createElement(EthereumIcon, { style: { width: 20, height: 20 } }),
                            React__default['default'].createElement(ChainName, { style: { fontFamily: 'CircularStd' } }, "Ethereum")))),
                React__default['default'].createElement(UserBlock$1, { account: account, login: login, logout: logout }),
                profile && React__default['default'].createElement(Avatar, { profile: profile }))),
        isMarket ?
            React__default['default'].createElement(MarketPanel, { showMenu: showMenu }, children) :
...
var templateObject_1$L, templateObject_2$h, templateObject_3$8, templateObject_4$3, templateObject_5$2, templateObject_6, templateObject_7, templateObject_8, templateObject_9, templateObject_10, templateObject_11, templateObject_12;
...
exports.CircleArrowDownIcon = Icon$k;
exports.CircleArrowUpIcon = Icon$l;
